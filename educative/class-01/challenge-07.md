...
### Solution Review:
Running Time Complexity = 1 + 1 + 1 + n + n + n + n = 3 + 5n. To find gthe Big O time complexity, 1. drop the leading constants and 2. drop the lower order terms. Therefore, the Big O time complexity of the above is 
